...
#################################################################################
# deepfake
# python train_classifier_dsvdd.py --device_num 6 --per_gpu_batch_size 32 --total_epoch 50 --lr 2e-5 --warmup_steps 2000\
#     --method dsvdd\
#     --out_dim 768\
#     --objective one-class\
#     --one_loss\
...
# raid
# python train_classifier_dsvdd.py --device_num 1 --per_gpu_batch_size 32 --total_epoch 50 --lr 2e-5 --warmup_steps 2000\
#     --method dsvdd\
#     --out_dim 768\
#     --one_loss\
#     --objective one-class\
...
#################################################################################
# deepfake
python train_classifier_energy.py --device_num 6 --per_gpu_batch_size 32 --total_epoch 50 --lr 2e-5 --warmup_steps 2000\
    --method energy\
    --classifier_dim 7\
    --only_classifier\
    --resum True\
    --pth_path /home/shengkun/ood-llm-detect/Deepfake_best.pth\
    --model_name princeton-nlp/unsup-simcse-roberta-base --dataset deepfake --path ${DATA_PATH}/Deepfake/cross_domains_cross_models \
    --name deepfake-roberta-base --freeze_embedding_layer --database_name train --test_dataset_name test\
